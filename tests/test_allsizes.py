...
class TestInput(unittest.TestCase):
    ...
    @gradescope_utils.autograder_utils.decorators.weight(1.0/3.0)
    @gradescope_utils.autograder_utils.decorators.tags("Small")
    def test_small(self):
        try:
            with open(file=pathlib.Path("./input/small.in"), mode="r") as f:
    ...
    def test_medium(self):
        try:
            with open(file=pathlib.Path("./input/medium.in"), mode="r") as f:
    ...
    def test_large(self):
        try:
            with open(file=pathlib.Path("./input/large.in"), mode="r") as f:
